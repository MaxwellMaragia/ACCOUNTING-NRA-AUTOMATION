Feature: [SUC:03-07]-Perform Credit Allocation
  ...
  Scenario Outline: UAT_M3_07-01-To verify all the fields are displayed in the Manage Credit Allocation Screen & Credit Allocation Screen
    ...
    Examples:
      ...
      | SearchForm:TIN | SearchForm:RevenueType | SearchForm:j_id10 | SearchForm:j_id11 | SearchForm:j_idt40 | SearchForm:Cancel | Tax Type      | Unallocated Credit Period | Document Type for Unallocated Credit | Unallocated Credit Amount | Outstanding Liability Period | Document Type for Outstanding Liability | Outstanding Liability Amount | CreditAllocation:TIN | CreditAllocation:EntityName | CreditAllocation:TaxType |
  ...
  Scenario Outline: UAT_M3_07-02-To verify the Credit Allocation Process (Suspense Account to Tax Type Account-Fully Cleared)
    ...
    Examples:
      ...
      | N0000036323 | Personal Income Tax | Account Adjustment | Processing Completed | Approved |
  ...
  Scenario Outline: UAT_M3_07-04-To verify the process of clearing Selection in Unallocated Credit Section
    ...
    Examples:
      ...
      | N0000036323 | Personal Income Tax | CreditAllocation:crClear | CreditAllocation:crBalance_input |
  ...
  Scenario Outline: UAT_M3_07-06-To verify the process of rejecting a Credit allocation Transaction
    ...
    Examples:
      ...
      | N0000036323 | Personal Income Tax | Account Adjustment | Processing Completed | Invalid data |
  ...
  Scenario Outline: UAT_M3_07-07-To verify the process of View Credit Allocation
    ...
    Examples:
      | ErrorMessage        | Tin         |
      | Please select a tin | N0000036323 |
