Feature: Revenue Control Accounting
 ...
 @UAT_M3_04-03
  Scenario Outline: UAT_M3_04-03-To verify all the fields displayed in the Tax Receivable Control Account
   ...
   | TaxReceivableControlAccount:TaxType | TaxReceivableControlAccount:TaxOffice | TaxReceivableControlAccount:TransactionType | TaxReceivableControlAccount:FromDate_input | TaxReceivableControlAccount:ToDate_input | TaxReceivableControlAccount:openingBalance | TaxReceivableControlAccount:closingBalance | TaxReceivableControlAccount:j_idt65 | DATE | TAX OFFICE      | TAXPAYER NAME | TIN | TRANSACTION DESCRIPTION | TAX TYPE       | DOCUMENT REFERENCE | DEBIT | CREDIT | BALANCE |
